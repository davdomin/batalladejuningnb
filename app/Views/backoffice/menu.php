                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <table class="table">
                                            <tbody>
                                                <tr>
                                                    <td colspan="3"><img id="imgTable" src="" class="rounded float-left"
                                                            style="max-width:200px; margin:auto" /></td>
                                                </tr>
                                                <tr>
                                                    <td><?php echo $nombre; ?></td>
                                                    <td><?php echo $apellidos; ?></td>
                                                    <td><button
                                                            onclick="cargar('Clientes/actualizar','Actualizar datos')"
                                                            class="btn btn-primary">Actualizar datos </button></td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    <td><button onclick="cargar('Clientes/depositar','Depositar')"
                                                            class="btn btn-primary">Depositar </button></td>
                                                    <td><button onclick="cargar('user/cerrarSesion','Cerrar sesión')"
                                                            class="btn btn-danger">Cerrar session </button></td>
                                                </tr>
                                        </table>
                                        </p>
                                    </div>
