...
-- Volcando datos para la tabla bd_control.abonos: ~9 rows (aproximadamente)
...
REPLACE INTO `abonos` (`id`, `cod_cliente`, `cod_datos_banco`, `cod_datos_estado`, `monto`, `referencia`, `observaciones`, `fecha_registro`, `fecha_deposito`) VALUES
	...
	(6, 1, 13, 14, 900, 'REF0002', 'PAPAPAPAPA', '2020-08-29 19:02:30', '2020-08-29'),
	(7, 1, 13, 14, 900, 'REF0002', 'PAPAPAPAPA', '2020-08-29 19:03:18', '2020-08-29'),
...
-- Volcando datos para la tabla bd_control.clientes: ~3 rows (aproximadamente)
...
-- Volcando datos para la tabla bd_control.datos: ~17 rows (aproximadamente)
