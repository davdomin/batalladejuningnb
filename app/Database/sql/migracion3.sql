...
-- Volcando datos para la tabla bd_control.abonos: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla bd_control.clasificacion: ~3 rows (aproximadamente)
...
-- Volcando datos para la tabla bd_control.datos: ~13 rows (aproximadamente)
...
-- Volcando datos para la tabla bd_control.menu: ~6 rows (aproximadamente)
