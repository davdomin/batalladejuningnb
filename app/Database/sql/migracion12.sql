...
REPLACE INTO `menu` (`id`, `cod_padre`, `nombre`, `controller`, `metodo`, `deleted`) VALUES
	...
	(13, 4, 'Aprobacion usuario', 'AdminController', 'aprobarUsuario', 0);
...
REPLACE INTO `users` (`id`, `name`, `email`, `email_verified_at`, `clave`, `remember_token`, `created_at`, `updated_at`, `deleted`, `deleted_at`, `cod_perfil`, `aprobado`) VALUES
	(1, 'David Dominguez', 'davdomin@gmail.com', NULL, 'Tmp*1986', NULL, NULL, NULL, 0, NULL, 2, 1),
	(2, 'Deybal Dominguez', 'dominguezd@gmail.com', NULL, '1234', NULL, NULL, NULL, 0, NULL, 2, 1),
	(3, 'Mario Antequera', 'marioantequera@gmail.com', '2020-09-20 13:34:35', '1234', NULL, NULL, NULL, 0, NULL, 2, 1),
	(4, 'Ale Domin', 'davadomin@gmail.com', NULL, '111111', NULL, NULL, NULL, 0, NULL, 3, 0),
	(5, 'edwin algar', 'davdomin+1@gmail.com', NULL, '123', NULL, NULL, NULL, 0, NULL, 1, 0);
